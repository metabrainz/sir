...
CREATE TRIGGER search_artist_delete_6 BEFORE DELETE ON area
    FOR EACH ROW EXECUTE PROCEDURE search_artist_delete_6();
COMMENT ON TRIGGER search_artist_delete_6 IS 'The path for this trigger is end_area';

CREATE TRIGGER search_artist_insert_6 AFTER INSERT ON area
    FOR EACH ROW EXECUTE PROCEDURE search_artist_insert_6();
COMMENT ON TRIGGER search_artist_insert_6 IS 'The path for this trigger is end_area';

CREATE TRIGGER search_artist_update_6 AFTER UPDATE ON area
    FOR EACH ROW EXECUTE PROCEDURE search_artist_update_6();
COMMENT ON TRIGGER search_artist_update_6 IS 'The path for this trigger is end_area';

CREATE TRIGGER search_artist_delete_7 BEFORE DELETE ON area_alias
    FOR EACH ROW EXECUTE PROCEDURE search_artist_delete_7();
COMMENT ON TRIGGER search_artist_delete_7 IS 'The path for this trigger is end_area.aliases';

CREATE TRIGGER search_artist_insert_7 AFTER INSERT ON area_alias
    FOR EACH ROW EXECUTE PROCEDURE search_artist_insert_7();
COMMENT ON TRIGGER search_artist_insert_7 IS 'The path for this trigger is end_area.aliases';

CREATE TRIGGER search_artist_update_7 AFTER UPDATE ON area_alias
    FOR EACH ROW EXECUTE PROCEDURE search_artist_update_7();
COMMENT ON TRIGGER search_artist_update_7 IS 'The path for this trigger is end_area.aliases';

CREATE TRIGGER search_artist_delete_8 BEFORE DELETE ON artist_ipi
    FOR EACH ROW EXECUTE PROCEDURE search_artist_delete_8();
COMMENT ON TRIGGER search_artist_delete_8 IS 'The path for this trigger is ipis';

CREATE TRIGGER search_artist_insert_8 AFTER INSERT ON artist_ipi
    FOR EACH ROW EXECUTE PROCEDURE search_artist_insert_8();
COMMENT ON TRIGGER search_artist_insert_8 IS 'The path for this trigger is ipis';

CREATE TRIGGER search_artist_update_8 AFTER UPDATE ON artist_ipi
    FOR EACH ROW EXECUTE PROCEDURE search_artist_update_8();
COMMENT ON TRIGGER search_artist_update_8 IS 'The path for this trigger is ipis';

CREATE TRIGGER search_artist_delete_9 BEFORE DELETE ON artist_type
    FOR EACH ROW EXECUTE PROCEDURE search_artist_delete_9();
COMMENT ON TRIGGER search_artist_delete_9 IS 'The path for this trigger is type';

CREATE TRIGGER search_artist_insert_9 AFTER INSERT ON artist_type
    FOR EACH ROW EXECUTE PROCEDURE search_artist_insert_9();
COMMENT ON TRIGGER search_artist_insert_9 IS 'The path for this trigger is type';

CREATE TRIGGER search_artist_update_9 AFTER UPDATE ON artist_type
    FOR EACH ROW EXECUTE PROCEDURE search_artist_update_9();
COMMENT ON TRIGGER search_artist_update_9 IS 'The path for this trigger is type';
...
CREATE TRIGGER search_label_delete_3 BEFORE DELETE ON label_ipi
    FOR EACH ROW EXECUTE PROCEDURE search_label_delete_3();
COMMENT ON TRIGGER search_label_delete_3 IS 'The path for this trigger is ipis';

CREATE TRIGGER search_label_insert_3 AFTER INSERT ON label_ipi
    FOR EACH ROW EXECUTE PROCEDURE search_label_insert_3();
COMMENT ON TRIGGER search_label_insert_3 IS 'The path for this trigger is ipis';

CREATE TRIGGER search_label_update_3 AFTER UPDATE ON label_ipi
    FOR EACH ROW EXECUTE PROCEDURE search_label_update_3();
COMMENT ON TRIGGER search_label_update_3 IS 'The path for this trigger is ipis';

CREATE TRIGGER search_label_delete_4 BEFORE DELETE ON label_type
    FOR EACH ROW EXECUTE PROCEDURE search_label_delete_4();
COMMENT ON TRIGGER search_label_delete_4 IS 'The path for this trigger is type';

CREATE TRIGGER search_label_insert_4 AFTER INSERT ON label_type
    FOR EACH ROW EXECUTE PROCEDURE search_label_insert_4();
COMMENT ON TRIGGER search_label_insert_4 IS 'The path for this trigger is type';

CREATE TRIGGER search_label_update_4 AFTER UPDATE ON label_type
    FOR EACH ROW EXECUTE PROCEDURE search_label_update_4();
COMMENT ON TRIGGER search_label_update_4 IS 'The path for this trigger is type';
...
CREATE TRIGGER search_recording_delete_17 BEFORE DELETE ON medium
    FOR EACH ROW EXECUTE PROCEDURE search_recording_delete_17();
COMMENT ON TRIGGER search_recording_delete_17 IS 'The path for this trigger is tracks.medium.release.mediums';

CREATE TRIGGER search_recording_insert_17 AFTER INSERT ON medium
    FOR EACH ROW EXECUTE PROCEDURE search_recording_insert_17();
COMMENT ON TRIGGER search_recording_insert_17 IS 'The path for this trigger is tracks.medium.release.mediums';

CREATE TRIGGER search_recording_update_17 AFTER UPDATE ON medium
    FOR EACH ROW EXECUTE PROCEDURE search_recording_update_17();
COMMENT ON TRIGGER search_recording_update_17 IS 'The path for this trigger is tracks.medium.release.mediums';
...
CREATE TRIGGER search_release_delete_7 BEFORE DELETE ON language
    FOR EACH ROW EXECUTE PROCEDURE search_release_delete_7();
COMMENT ON TRIGGER search_release_delete_7 IS 'The path for this trigger is language';

CREATE TRIGGER search_release_insert_7 AFTER INSERT ON language
    FOR EACH ROW EXECUTE PROCEDURE search_release_insert_7();
COMMENT ON TRIGGER search_release_insert_7 IS 'The path for this trigger is language';

CREATE TRIGGER search_release_update_7 AFTER UPDATE ON language
    FOR EACH ROW EXECUTE PROCEDURE search_release_update_7();
COMMENT ON TRIGGER search_release_update_7 IS 'The path for this trigger is language';

CREATE TRIGGER search_release_delete_8 BEFORE DELETE ON script
    FOR EACH ROW EXECUTE PROCEDURE search_release_delete_8();
COMMENT ON TRIGGER search_release_delete_8 IS 'The path for this trigger is script';

CREATE TRIGGER search_release_insert_8 AFTER INSERT ON script
    FOR EACH ROW EXECUTE PROCEDURE search_release_insert_8();
COMMENT ON TRIGGER search_release_insert_8 IS 'The path for this trigger is script';

CREATE TRIGGER search_release_update_8 AFTER UPDATE ON script
    FOR EACH ROW EXECUTE PROCEDURE search_release_update_8();
COMMENT ON TRIGGER search_release_update_8 IS 'The path for this trigger is script';
...
CREATE TRIGGER search_release_group_delete_1 BEFORE DELETE ON release
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_delete_1();
COMMENT ON TRIGGER search_release_group_delete_1 IS 'The path for this trigger is releases';

CREATE TRIGGER search_release_group_insert_1 AFTER INSERT ON release
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_insert_1();
COMMENT ON TRIGGER search_release_group_insert_1 IS 'The path for this trigger is releases';

CREATE TRIGGER search_release_group_update_1 AFTER UPDATE ON release
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_update_1();
COMMENT ON TRIGGER search_release_group_update_1 IS 'The path for this trigger is releases';

CREATE TRIGGER search_release_group_delete_2 BEFORE DELETE ON artist_credit
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_delete_2();
COMMENT ON TRIGGER search_release_group_delete_2 IS 'The path for this trigger is artist_credit';

CREATE TRIGGER search_release_group_insert_2 AFTER INSERT ON artist_credit
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_insert_2();
COMMENT ON TRIGGER search_release_group_insert_2 IS 'The path for this trigger is artist_credit';

CREATE TRIGGER search_release_group_update_2 AFTER UPDATE ON artist_credit
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_update_2();
COMMENT ON TRIGGER search_release_group_update_2 IS 'The path for this trigger is artist_credit';

CREATE TRIGGER search_release_group_delete_3 BEFORE DELETE ON artist_credit_name
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_delete_3();
COMMENT ON TRIGGER search_release_group_delete_3 IS 'The path for this trigger is artist_credit.artists';

CREATE TRIGGER search_release_group_insert_3 AFTER INSERT ON artist_credit_name
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_insert_3();
COMMENT ON TRIGGER search_release_group_insert_3 IS 'The path for this trigger is artist_credit.artists';

CREATE TRIGGER search_release_group_update_3 AFTER UPDATE ON artist_credit_name
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_update_3();
COMMENT ON TRIGGER search_release_group_update_3 IS 'The path for this trigger is artist_credit.artists';

CREATE TRIGGER search_release_group_delete_4 BEFORE DELETE ON artist
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_delete_4();
COMMENT ON TRIGGER search_release_group_delete_4 IS 'The path for this trigger is artist_credit.artists.artist';

CREATE TRIGGER search_release_group_insert_4 AFTER INSERT ON artist
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_insert_4();
COMMENT ON TRIGGER search_release_group_insert_4 IS 'The path for this trigger is artist_credit.artists.artist';

CREATE TRIGGER search_release_group_update_4 AFTER UPDATE ON artist
    FOR EACH ROW EXECUTE PROCEDURE search_release_group_update_4();
COMMENT ON TRIGGER search_release_group_update_4 IS 'The path for this trigger is artist_credit.artists.artist';
COMMIT;
